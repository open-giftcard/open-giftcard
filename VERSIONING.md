...
without a previous release to compare against: the API compatibility gate needs a
...
until `v0.9.0` no repository had one. Repoint it at `v0.9.1` in the change that
