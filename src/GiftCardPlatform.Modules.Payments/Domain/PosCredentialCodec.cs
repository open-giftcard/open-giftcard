...
/// <summary>
/// POS client secrets are 256 CSPRNG bits, so a plain SHA-256 digest is an
/// appropriate store: there is no low-entropy guess space to slow down, which is
/// the same reasoning the platform already applies to refresh tokens and
/// invitation secrets. A password KDF is reserved for human-chosen values such
/// as the six-digit share PIN.
/// </summary>
internal static class PosCredentialCodec
{
