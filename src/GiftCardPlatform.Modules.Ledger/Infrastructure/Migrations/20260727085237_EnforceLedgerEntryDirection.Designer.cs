...
namespace GiftCardPlatform.Modules.Ledger.Infrastructure.Migrations
{
    ...
    [Migration("20260727085237_EnforceLedgerEntryDirection")]
    partial class EnforceLedgerEntryDirection
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("accounts", "ledger", t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_ledger_accounts_scope", "(\"type\" = 'PlatformFunding' AND \"organization_id\" IS NULL)\nOR\n(\"type\" = 'OrganizationCorporateCredit' AND \"organization_id\" IS NOT NULL)");
                        });
                });
